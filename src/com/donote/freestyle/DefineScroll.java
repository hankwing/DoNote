...
public class DefineScroll extends ScrollView {
	...
	public DefineScroll(Context context) {
		super(context);
		init();
	}

	public DefineScroll(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public DefineScroll(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

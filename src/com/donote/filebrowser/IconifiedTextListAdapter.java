...
public class IconifiedTextListAdapter extends BaseAdapter {
	...
	int pos;
	static IconifiedTextView itemGroup[];
	// 用于显示文件的列表
	private List<IconifiedText> mItems = new ArrayList<IconifiedText>();

	public IconifiedTextListAdapter(Context context) {
		mContext = context;
		itemGroup = new IconifiedTextView[getCount()];
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		itemGroup[position] = btv;
		pos = position;
		return btv;
	}

	public IconifiedTextView getchidView(int location) {
		return (IconifiedTextView) itemGroup[location];
	}

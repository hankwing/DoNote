...
public class ColorPicker extends View {
	 ...
	 */
	public int mColorPointerRadius;
	...
	private PaintSizeBar mPaintSizeBar = null;
	...
	public void setPaintSize(int size) {
		...
		if(px2dip(mContext, size/2) > 14) {
			mColorPointerRadius = size/2;
			mColorPointerHaloRadius = size/2 + dip2px(mContext, 4);
		}
		else {
			mColorPointerRadius = size/2;
			mColorPointerHaloRadius = dip2px(mContext, 18);
		}
		
		if (onColorChangedListener != null) {
			onColorChangedListener.onSizeChanged(size);
		}
		invalidate();
	}
	...
	public void setColor(int color) {
		...
		if (mPaintSizeBar != null) {
			// set the value of the opacity
			mPaintSizeBar.setColor(mColor);
			mPaintSizeBar.setOpacity(Color.alpha(color));
		}
	...
	public void addSizeBar(PaintSizeBar bar) {
		mPaintSizeBar = bar;
		// Give an instance of the color picker to the Opacity bar.
		mPaintSizeBar.setColorPicker(this);
		mPaintSizeBar.setColor(mColor);
	}
	...
	public void changeSizeBarColor(int color) {
		if (mPaintSizeBar != null) {
			mPaintSizeBar.setColor(color);
		}
	}
